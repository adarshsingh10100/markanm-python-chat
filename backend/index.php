...
try {
    ...
    } else if ($method === 'GET' && preg_match('#^/(?:admin/api/|admin/|api/public/|public/)?branding$#', $path)) {
        AdminController::getBrandingSettings();
    } else if ($method === 'POST' && preg_match('#^/(?:admin/api/|admin/)?branding/upload$#', $path)) {
        AdminController::uploadBrandingAsset();
    } else if ($method === 'POST' && preg_match('#^/(?:admin/api/|admin/)?branding$#', $path)) {
